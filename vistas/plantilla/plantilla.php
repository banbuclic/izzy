...
<head>
    ...
    <link href="<?php echo htmlspecialchars(SERVERURL, ENT_QUOTES, 'UTF-8'); ?>vistas/plantilla/css/izzy-modern-theme.css" rel="stylesheet" />
...
<body class="sb-nav-fixed izzy-modern-ui<?php echo $modoSoloLecturaPagoActivo ? ' izzy-payment-readonly' : ''; ?>">
    <?php
