<?php
/**
 * IZZY | Tabler Icons locales (outline)
 * SVG integrados localmente para evitar dependencias de CDN.
 * Fuente: Tabler Icons (MIT).
 */
if (!function_exists('izzyTablerIcon')) {
    function izzyTablerIcon($name, $class = '', $label = '') {
        static $icons = [
            ...
            'packages' => '<path d="M7 16.5l-5 -3l5 -3l5 3v5.5l-5 3l0 -5.5" /><path d="M2 13.5v5.5l5 3" /><path d="M7 16.545l5 -3.03" /><path d="M17 16.5l-5 -3l5 -3l5 3v5.5l-5 3l0 -5.5" /><path d="M12 19l5 3" /><path d="M17 16.5l5 -3" /><path d="M12 13.5v-5.5l-5 -3l5 -3l5 3v5.5" /><path d="M7 5.03v5.455" /><path d="M12 8l5 -3" />',
            ...
            'file-spreadsheet' => '<path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2" /><path d="M8 11h8v7h-8l0 -7" /><path d="M8 15h8" /><path d="M11 11v7" />',
        ...
        $safeName = preg_replace('/[^a-z0-9\-]/i', '', (string)$name);
        if (!isset($icons[$safeName])) {
            return '';
        }

        $safeClass = trim(preg_replace('/[^a-zA-Z0-9_\-\s]/', '', (string)$class));
        $classes = 'izzy-tabler-icon' . ($safeClass !== '' ? ' ' . $safeClass : '');
        $aria = $label !== ''
